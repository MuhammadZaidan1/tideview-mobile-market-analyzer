...
void callbackDispatcher() {
  Workmanager().executeTask((task, inputData) async {
    try {
      ...
      // FIX: sama seperti market_sync_usecase.dart -- assets yang
      // di-watchlist tapi udah gak masuk hasil fetch top-N kali ini tetap
      // di-carry-over, biar gak ilang diam-diam dari watchlist.
