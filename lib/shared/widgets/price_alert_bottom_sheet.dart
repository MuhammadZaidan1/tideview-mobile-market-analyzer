...
import 'asset_selector_screen.dart';
                ...
                child: Row(
                  children: [
                    if (_selectedAsset != null) ...[
                      ...
                      // Harga juga ditampilin dalam format lokal!
                      Text(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: _isAbove
                            ...
                            : Colors.transparent,
                        border: Border.all(
                          color: _isAbove ? Colors.green : Colors.grey.shade300,
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: !_isAbove
                            ...
                            : Colors.transparent,
                        border: Border.all(
                          color: !_isAbove ? Colors.red : Colors.grey.shade300,
                          width: !_isAbove ? 1.5 : 1,
                        ),
                        borderRadius: BorderRadius.circular(12),
                      ),
