...
import '../../shared/widgets/custom_popup.dart' as popup;
...
class _AssetDetailScreenState extends ConsumerState<AssetDetailScreen> {
  ...
  Future<void> _takeScreenshotAndShare() async {
    try {
      ...
      popup.CustomPopup.showSnackBar(
        context,
        message: l10n.preparingImage,
        type: popup.PopupType.alert,
      ...
      popup.CustomPopup.showSnackBar(
        ...
        type: popup.PopupType.caution,
      );
    }
  }

  Future<void> _toggleWatchlist(bool nextValue) async {
    await HapticFeedback.selectionClick();
    final previousValue = _isWatchlisted;
    widget.asset.isWatchlisted = nextValue;
    if (mounted) {
      setState(() => _isWatchlisted = nextValue);
    }
    ...
    try {
      ...
      widget.asset.isWatchlisted = previousValue;
      if (mounted) {
        setState(() => _isWatchlisted = previousValue);
      }
      rethrow;
    }
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              popup.CustomPopup.showAppBottomSheet(
                context: context,
                child: PriceAlertBottomSheet(initialAsset: widget.asset),
              );
            },
          ),
          FavoriteButton(
            initialValue: _isWatchlisted,
            successMessage: l10n.addedToWatchlist,
            removedMessage: l10n.removedFromWatchlist,
            errorMessage: 'Could not update watchlist',
