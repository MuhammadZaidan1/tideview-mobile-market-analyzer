              ...
              child: IconButton(
                ...
                onPressed: () {
                  ...
                  CustomPopup.showAppBottomSheet(
                    context: context,
                    child: const PriceAlertBottomSheet(initialAsset: null),
                  );
                },
              ),
            ),
                        ...
                        child: GestureDetector(
                          ...
                          child: AssetCard(
                            ...
                            trailing: FavoriteButton(
                              initialValue: asset.isWatchlisted,
                              ...
                              onToggle: (nextValue) async {
                                HapticFeedback.lightImpact();
                                final previousValue = asset.isWatchlisted;
                                asset.isWatchlisted = nextValue;
                                try {
                                  ...
                                  asset.isWatchlisted = previousValue;
                                  rethrow;
                                }
                              },
                            ),
