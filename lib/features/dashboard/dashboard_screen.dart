...
class _DashboardScreenState extends ConsumerState<DashboardScreen>
  ...
  Future<void> _saveSortOrderToIsar(List<AssetCache> assets) async {
    try {
      ...
      debugPrint('Failed to save sort order: $e');
    }
  }
                  ...
                  onPressed: () async {
                    ...
                    if (name.isNotEmpty) {
                      ...
                      CustomPopup.showAppDialog<void>(
                        ...
                        onConfirm: () => Navigator.pop(navigatorContext),
                      );
                    }
                  },
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            '${AppLocalizations.of(stateContext)!.editCategory} "$categoryName"',
                            ...
                            itemBuilder: (itemContext, index) {
                              ...
                              return CheckboxListTile(
                                ...
                                onChanged: (val) async {
                                  ...
                                  await IsarService().toggleAssetCustomCategory(
                                    asset.symbol,
                                    categoryName,
                                  );
                                  setModalState(() {
